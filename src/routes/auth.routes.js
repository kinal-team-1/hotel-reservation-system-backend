...
router.get("/token/client", [validateJwt, isClientLogged], validateToken);
router.get("/token/hotel", [validateJwt, isHotelAdminLogged], validateToken);
router.get("/token/admin", [validateJwt, isAdminLogged], validateToken);
